...
@available(iOS 16.1, *)
struct InsertIntoArrayView: View {
    ...
    var body: some View {
        VStack{
            ...
            Button {
                do{
                    try insertIntoArray(numbersString: textContent)
                    alertSuccess.toggle()
                    textContent = ""
                }
...
@available(iOS 16.1, *)
struct InsertIntoArrayView_Previews: PreviewProvider {
